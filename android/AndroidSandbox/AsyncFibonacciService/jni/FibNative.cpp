...
namespace com_marakana_android_asyncfibonacciservice{
	...
	using namespace com_marakana_android_asyncfibonacciservice;
	...
	extern "C" jint JNI_OnLoad(JavaVM* vm, void* reserved) {
	    ...
	    if (vm->GetEnv(reinterpret_cast<void**>(&env), JNI_VERSION_1_6) != JNI_OK) {
	        ...
	        jclass clazz = env->FindClass("com/marakana/android/asyncfibonacciservice/Fiblib");
	        if (clazz) {
